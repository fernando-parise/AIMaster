  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { name: 'Cursos Populares', path: '/courses?filter=popular' },
        { name: 'Novos Lançamentos', path: '/courses?filter=newest' },
        { name: 'Em Breve', path: '/courses?filter=upcoming' }
      ]
    },
    {
      title: 'Sobre Nós',
      links: [
        { name: 'Sobre a Empresa', path: '/about' },
        { name: 'Equipe de Instrutores', path: '/instructors' },
        { name: 'Trabalhe Conosco', path: '/careers' },
        { name: 'Contato', path: '/contact' }
      ]
    },
    {
      title: 'Serviços para Assinantes',
      links: [
        { name: 'Planos de Assinatura', path: '/subscription' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Oferecemos cursos online de alta qualidade ministrados por especialistas do setor, ajudando você a dominar habilidades práticas e iniciar uma nova jornada profissional.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Plataforma de Cursos Online AIMASTER. Todos os direitos reservados.
            </p>
